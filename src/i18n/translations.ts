...
export const TRANSLATIONS: Record<Language, Translations> = {
  kz: {
    ...
    unlockKitchen: 'Асүй экранын ашу',
    ...
    heroBadge: 'FoodMaxxing',
    heroTitle: 'FoodMaxxing',
    heroDesc: 'Maximum food. Minimum waiting',
    badge3steps: '3 қадам',
    ...
    colScheduled: 'Дайындалуға жоспарланған',
    colCooking: 'Станцияларда дайындалуда',
    colReady: 'Сөреде дайын',
  ...
  ru: {
    ...
    colScheduled: 'Запланировано к готовке',
    colCooking: 'Готовится на станциях',
    colReady: 'Готово на полке выдачи',
    autoFires: 'Авто-старт',
  ...
  en: {
    ...
    colScheduled: 'Scheduled for JIT Fire',
    colCooking: 'Cooking On Stations',
    colReady: 'Ready on Shelf Rack',
